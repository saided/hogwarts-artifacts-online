...
public class DbDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //Saving or Updating the wizard data will automatically save the child artifacts data since we kept casacade type as
        // persist and merge(update) in the wizard class.

        wizardRepository.save(w1);
        wizardRepository.save(w2);
        wizardRepository.save(w3);

        //a6 doesnot have any wiazrd so save it seperately
